...
# -*- coding: utf-8 -*-
"""
Created on Sat May 22 08:12:29 2021
...
class BuckBoost:
    ...
    def run_nonlinsolve(self, given, want):
        ...
        self.debug('nonlinsolve returns: {}'.format(rhs_tuple ))
        if len(rhs_tuple) != 1:
    ...
    def addnewrelation(self, sym, solutions):
        ...
        '''
        #this is cludgy!!!!
        #mapping = {delta_iL: symbols('delta_iL'), delta_Vc: symbols('delta_Vc')}
        funcs = list()
    ...
    def computesym(self, sym, given):
        ...
        for exp in self.relations[sym]:
            ...
            try: 
                ...
                continue #don't both any more with this exp
